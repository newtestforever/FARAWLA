...
if res ~= 200 then
print('\27[0;31mღ═───═𝙎𝙊𝙐𝙍𝘾𝙀 𝙁𝘼𝙍𝙒𝙇𝘼 ❈═───═ღ\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \naღ═───═𝙎𝙊𝙐𝙍𝘾𝙀 𝙁𝘼𝙍𝙒𝙇𝘼 ❈═───═ღ\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35mღ═───═𝙎𝙊𝙐𝙍𝘾𝙀 𝙁𝘼𝙍𝙒𝙇𝘼 ❈═───═ღ\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
rm -fr ../.telegram-cli
if [ ! -f ./tg ]; then
echo "ღ═───═𝙎𝙊𝙐𝙍𝘾𝙀 𝙁𝘼𝙍𝙒𝙇𝘼 ❈═───═ღ ┉ ┉ ┉ ┉ ┉ ┉┉ ┉ ┉ ┉ ┉ ┉ ┉"
echo "TG IS NOT FIND IN FILES BOT"
echo "ღ═───═𝙎𝙊𝙐𝙍𝘾𝙀 𝙁𝘼𝙍𝙒𝙇𝘼 ❈═───═ღ ღ═───═𝙎𝙊𝙐𝙍𝘾𝙀 𝙁𝘼𝙍𝙒𝙇𝘼 ❈═───═ღ ┉"
exit 1
fi
if [ ! $token ]; then
echo "ღ═───═𝙎𝙊𝙐𝙍𝘾𝙀 𝙁𝘼𝙍𝙒𝙇𝘼 ❈═───═ღ ღ═───═𝙎𝙊𝙐𝙍𝘾𝙀 𝙁𝘼𝙍𝙒𝙇𝘼 ❈═───═ღ ┉ ┉"
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/MADISON11100/FARAWLA/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1208165035,1859346570,1891401672,30,50}   
...
var = true
elseif tonumber(user_id) == tonumber(1891401672) then
var = true
...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'فراوله'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
local UserName = (data.username_ or "frawla2021")
...
local frawla2021 = database:get(bot_id..'text:ch:user')
if frawla2021 then
send(msg.chat_id_, msg.id_,'['..frawla2021..']')
else
...
os.execute('wget https://raw.githubusercontent.com/MADISON11100/FARAWLA/main/DRAGON.lua')
send(msg.chat_id_, msg.id_,'ღ تم تحديث السورس')
dofile('DRAGON.lua')  
end
if text == 'الاصدار ' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ღ اصدار سورس فراوله { s: 6.7}')
end
if text == 'مالك السورس' or text == 'المبرمج بويكا' or text == 'بويكا مبرمج السورس' or text =='بويكا التاني' then
local Text =[[
...
{
{text = '☼︎𝐷𝑒𝑣 𝑏𝑜𝑦𝑘𝑎☼︎', url = "https://t.me/ha_rr_y_ha_ma"},
},
{
...
if text == 'تاكي' or text == 'المبرمج تاكي' or text == 'تاكي مبرمج السورس' or text == 'الشيخ تاكي' then
local Text =[[


للتواصل مع تاكي مطور السورس
اتبع الازرار الاتيه♦️
...
{
{text = '☼︎𝐷𝑒𝑣 𝑡𝑎𝑘𝑦☼︎', url = "https://t.me/Dad_taky"},
},
{
{text = '𝙎𝙊𝙐𝙍𝘾𝙀 𝙁𝘼𝙍𝙒𝙇𝘼 ❈', url = "https://t.me/frawla2021"},
},
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Dad_taky&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
{
{text = '𝐒𝐨𝐮𝐫𝐜𝐞 𝐏𝐫𝐨𝐠𝐫𝐚𝐦𝐦𝐞𝐫𝐬', url = "https://t.me/US_FRAWLA"},
},
{
{text = '𝙎𝙊𝙐𝙍𝘾𝙀 𝙁𝘼𝙍𝙒𝙇𝘼 ❈', url = "https://t.me/frawla2021"}
},
...
usertext = '\n ღ العضو ← ['..result.title_..'](t.me/'..(username or 'frawla2021')..')'
status  = '\n ღ تم ترقيته مطور'
...
usertext = '\n ღ العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'frawla2021')..')'
status  = '\n ღ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ღ العضو ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'frawla2021')..') \n ღ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ღ العضو : {["..data.first_name_.."](t.me/frawla2021)}\n ღ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ღ عذرا ← {["..data.first_name_.."](t.me/frawla2021)}\n ღ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
os.execute('rm -rf DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/MADISON11100/FARAWLA/main/DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/MADISON11100/FARAWLA/main/library')
os.execute('wget https://raw.githubusercontent.com/MADISON11100/FARAWLA/main/File_Bot')
send(msg.chat_id_, msg.id_,' ღ تم تحديث السورس')
dofile('DRAGON.lua')  
end
...
{{text = 'اضــف الـبـوت لـمـجـمـوعـتـك', url="https://t.me/B_o_y_k_a_bot?startgroup=new"}},  
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/frawla2021&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'بويكا' or text == 'المبرمج بويكا' or text == 'بويكا مبرمج السورس' or text == 'بويكا التاني' then
local Text =[[
...
if text == 'كسسسسسسسسسس' or text == 'عنعنعنعنعنعنعنعنععنعنعنعنع' then
local Text = [[
   حصلخير بحبك @jokerrap2
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '  ❨ 𝑱𝑶𝑲𝑬𝑹 𝑹𝑨𝑩  ❩ ',url="t.me/jokerrap2"}},
}
local msg_id = msg.id_/2097152/0.5
...
"سؤال ينرفزك ؟ ", 
" هل يعجبك سورس فراوله ؟؟ ", 
" اكثر ممثل تحبه ؟ ", 
"قد تخيلت شي في بالك وصار ؟ ", 
"شيء عندك اهم من الناس ؟ ", 
"تفضّل النقاش الطويل او تحب الاختصار ؟ ", 
"وش أخر شي ضيعته؟ ", 
"اي رايك في سورس فراوله ؟ ", 
"كم مره حبيت؟ ", 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '  ❨ ♬ 𝐒𝐎𝐔𝐑𝐂𝐄 ♬  ❩', url="t.me/frawla2021"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'ღ═───═𝙎𝙊𝙐𝙍𝘾𝙀 𝙁𝘼𝙍𝙒𝙇𝘼 ❈═───═ღ' then
local Text = [[ 
♬من أحسن السورسات على التليجرام سورس فراوله♬
...
if text == 'العاب فراوله' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
 ♬ اهلا في قائمه الالعاب المتطوره سورس فراوله  ♬ 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ღ بواسطه ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'frawla2021')..') \n ღ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ღ بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'frawla2021')..') \n ღ تـم قفـل التاك بالكتم ')
end,nil)   
...
if tonumber(result.sender_user_id_) == tonumber(1859346570) then  
send(msg.chat_id_, msg.id_, " ღ لا تسطيع حظر مالك السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1891401672) then  
...
if result.id_ == tonumber(1859346570) then
send(msg.chat_id_, msg.id_, " ღ لا تسطيع حظر مالك السورس عام \n")
return false 
end
if result.id_ == tonumber(1891401672) then
send(msg.chat_id_, msg.id_, " ღ لا تسطيع حظر مطور السورس عام \n")
return false 
end
...
if tonumber(userid) == tonumber(1859346570) then  
send(msg.chat_id_, msg.id_, " ღ لا تسطيع حظر مالك السورس عام")
return false 
end
if tonumber(userid) == tonumber(1891401672) then  
send(msg.chat_id_, msg.id_, " ღ لا تسطيع حظر مطور السورس عام")
return false 
end
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/MADISON11100/FARAWLA/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ღ اهلا بك في متجر ملفات فراوله\n ღ ملفات السورس ↓\n≪◤━───━??𝗼𝗼𝗼𝗻━───━◥≫\n\n"
local TextE = "\nღ═───═𝙎𝙊𝙐𝙍𝘾𝙀 𝙁𝘼𝙍𝙒𝙇𝘼 ❈═───═ღ\n ღ علامة تعني { ✔️ } ملف مفعل\n ღ علامة تعني { ✖ } ملف معطل\n ღ قناة سورس فراوله ↓\n".." ღ [اضغط هنا لدخول](t.me/frawla2021) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/MADISON11100/FARAWLA/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DRAGON.lua')  
else
send(msg.chat_id_, msg.id_," ღ عذرا الملف لايدعم سورس فراوله \n") 
end
return false
end
...
if text == ("مسح قائمه فراوله") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ღ تم مسح قائمه فراوله')
return false
end

if text == 'قائمه فراوله' and Sudo(msg) then
...
if #list == 0 then
t = " ღ لا يوجد احد في قائمه فراوله"
end
send(msg.chat_id_, msg.id_, t)
return false
end
...
if text == ("رفع فراوله") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local frawla2021 = database:get(bot_id..'text:ch:user')
if frawla2021 then
send(msg.chat_id_, msg.id_,'['..frawla2021..']')
...
if text and text:match("^رفع فراوله @(.*)$") and Sudo(msg) then
local username = text:match("^رفع فراوله @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local frawla2021 = database:get(bot_id..'text:ch:user')
if frawla2021 then
send(msg.chat_id_, msg.id_,'['..frawla2021..']')
...
if text and text:match("^رفع فراوله (%d+)$") and Sudo(msg) then
local userid = text:match("^رفع فراوله (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local frawla2021 = database:get(bot_id..'text:ch:user')
if frawla2021 then
send(msg.chat_id_, msg.id_,'['..frawla2021..']')
...
if text == ("تنزيل فراوله") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local frawla2021 = database:get(bot_id..'text:ch:user')
if frawla2021 then
send(msg.chat_id_, msg.id_,'['..frawla2021..']')
...
if text and text:match("^تنزيل فراوله @(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل فراوله @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local frawla2021 = database:get(bot_id..'text:ch:user')
if frawla2021 then
send(msg.chat_id_, msg.id_,'['..frawla2021..']')
...
if text and text:match("^تنزيل فراوله (%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل فراوله (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local frawla2021 = database:get(bot_id..'text:ch:user')
if frawla2021 then
send(msg.chat_id_, msg.id_,'['..frawla2021..']')
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ღ لعضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'frawla2021')..')'
status  = '\n ღ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ღ العضو ← '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ღ العضــو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'frawla2021')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ღ العضو ← ['..result.title_..'](t.me/'..(text1[3] or 'frawla2021')..')'..'\n ღ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
database:set(bot_id.."frawla2021:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,' تم تفعيل الانستا')
database:set(bot_id.."frawla2021:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."frawla2021:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."frawla2021:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"ღتم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."frawla2021:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."frawla2021:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس فراوله يعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'فراوله').." غادر" or text == 'غادر' then  
...
send(msg.chat_id_,msg.id_, '[انت مطوري نور عنيا🥺🤍](t.me/frawla2021)') 
return false
end

if text == 'انا مين' and DevSoFi(msg) then 
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/frawla2021)') 
return false
end

if text == 'انا مين' and Sudo(msg) then 
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/frawla2021)') 
return false
end

if text == 'انا مين' and CoSu(msg) then 
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوق راسي 😂♥](t.me/frawla2021)') 
return false
end

if text == 'انا مين' and Constructor(msg) then 
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/frawla2021)') 
return false
end

if text == 'انا مين' and BasicConstructor(msg) then 
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/frawla2021)') 
return false
end

if text == 'انا مين' and Manager(msg) then 
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/frawla2021)') 
return false
end

if text == 'انا مين' and Mod(msg) then 
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/frawla2021)') 
return false
end

if text == 'انا مين' and Special(msg) then 
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/frawla2021)') 
return false
end

if text == 'انا مين' then
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/frawla2021)') 
return false
end
...
if text == 'سلام' then 
send(msg.chat_id_,msg.id_, '[ابق تعاله كليوم..😹💔🎶](t.me/frawla2021)') 
return false
end

if text == 'هاي' or text == 'هيي' then
send(msg.chat_id_,msg.id_, '[علي الواي فاي..😺💜](t.me/frawla2021)') 
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/frawla2021)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[علي فين يوسخ..🙂😹](t.me/frawla2021)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[طب انا بحبك يوه..💔🥺](t.me/frawla2021)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[بحبح اكتر ..🙂❤️](t.me/frawla2021)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[ونا كان مين قالي ميسد ..🙂💔](t.me/frawla2021)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[شخصيه انت يعني ..🙂😹](t.me/frawla2021)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[ قولي بحب الفضايح ..🙂😹](t.me/frawla2021)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[ اومرني يقلبي ..❤️](t.me/frawla2021)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[ كان نفسي ابقا محترم شبهك بس مجموعي مجبش ..😹🙂](t.me/frawla2021)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[ هو مفكرني بني ادم ..😹🙂](t.me/frawla2021)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[يلا متجيش هنا تاني..😹🙂](t.me/frawla2021)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/frawla2021)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[نزل عينك عيب كده..🌚♥️](t.me/frawla2021)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[انت الخير يعمري..🌚♥️](t.me/frawla2021)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عادي يتفلق هنعلمو اي يعني..💔😒](t.me/frawla2021)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وتسبني لمين طيب..💔🥺](t.me/frawla2021)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[يحلات عيونك..♥️🦋](t.me/frawla2021)')
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عايز من ده..💋🥀](t.me/frawla2021)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بف..🙄💔](t.me/frawla2021)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[متزعلش بحبك..😥♥️](t.me/frawla2021)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وانا كمان بحبك .🥺❤️](t.me/frawla2021)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بيف ..🙄💔](t.me/frawla2021)')
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤🌚](t.me/frawla2021)') 
return false
end
end
end

if text == ""..(database:get(bot_id..'Name:Bot') or 'فراوله').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'فراوله')
local DRAGON_Msg = {
'نعم يروحي😻💙',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
...
local Namebot = (database:get(bot_id..'Name:Bot') or 'فراوله')
local DRAGON_Msg = {
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'frawla2021')..')'
local iduser = result.sender_user_id_
...
send(msg.chat_id_, msg.id_, t..'━━━━━━\nاضغط علي الاسم ليتم نسخه\nღ═───═𝙎𝙊𝙐𝙍𝘾𝙀 𝙁𝘼𝙍𝙒𝙇𝘼 ❈═───═ღ\n ღ[ 𝙎𝙊𝙐𝙍𝘾𝙀 𝙁𝘼𝙍𝙒𝙇𝘼 ❈ ](t.me/frawla2021)ღ ')
end
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'فراوله')
